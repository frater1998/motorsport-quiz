...
import { Trophy, RefreshCw, Home, CheckCircle2, XCircle, Zap, Flame, Clock, Award, Shield } from 'lucide-react';
    ...
    <div className="w-full max-w-4xl mx-auto px-4 py-8 sm:py-12 space-y-8 animate-in fade-in zoom-in-95 duration-400">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        ...
        >
          ...
          <span>RIGIOCA NUOVA GARA (Domande Generiche)</span>
        </button>

        <button
          onClick={onGoHome}
          className="w-full sm:w-auto px-6 py-4 rounded-xl bg-[#151922] hover:bg-[#1f2634] text-slate-300 hover:text-white border border-[#232936] font-digital font-bold text-base tracking-wider flex items-center justify-center gap-2 transition cursor-pointer"
        >
          <Home className="w-5 h-5 text-slate-400" />
          <span>CAMBIA CATEGORIA / EPOCA</span>
        </button>
      </div>
